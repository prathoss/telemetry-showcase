...
const (
	User_GetUserById_FullMethodName    = "/showcase.User/GetUserById"
	User_GetUserByEmail_FullMethodName = "/showcase.User/GetUserByEmail"
)
...
type UserClient interface {
	...
	GetUserByEmail(ctx context.Context, in *GetUserByEmailRequest, opts ...grpc.CallOption) (*UserReply, error)
}
...
func (c *userClient) GetUserByEmail(ctx context.Context, in *GetUserByEmailRequest, opts ...grpc.CallOption) (*UserReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserReply)
...
type UserServer interface {
	...
	GetUserByEmail(context.Context, *GetUserByEmailRequest) (*UserReply, error)
...
func (UnimplementedUserServer) GetUserByEmail(context.Context, *GetUserByEmailRequest) (*UserReply, error) {
